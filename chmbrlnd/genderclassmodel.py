...
csv_file_object = csv.reader(open('train.csv', newline=''))       # Load in the csv file
...
# First read in test
test_file = open('test.csv', newline='')
test_file_object = csv.reader(test_file)
header = next(test_file_object)

# Also open the a new file so I can write to it. 
predictions_file = open('genderclassmodel.csv', 'w', newline='')
