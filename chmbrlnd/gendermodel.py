...
csv_file_object = csv.reader(open('train.csv', 'r', newline='')) 	# Load in the csv file
...
proportion_survivors = int(number_survived / number_passengers)
...
test_file = open('test.csv', 'r', newline='')
